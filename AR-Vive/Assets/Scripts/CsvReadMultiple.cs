...
public class CsvReadMultiple : MonoBehaviour {
	...
	public void LoadQuestionnaire(int qIndex) {
		Load (files[qIndex], questionnaireInput);
		//Debug.Log(questionnaireInput [0]);
	}

	private bool Load(string fileName, List<string> arrayToTransferTo) {

		arrayToTransferTo.Clear ();
